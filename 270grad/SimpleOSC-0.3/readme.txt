...
How to use:
Download and install pyOSC from https://trac.v2.nl/wiki/pyOSC
Check the examples provided. You can place the basicOSC.py file next to your module
or you can also copy it into the python site-packages folder (if you know where this lives in your system. Note that firewalls and routers tend to block nerwork ports for security. Make sure you use ports that are open for the OSC comunication.
